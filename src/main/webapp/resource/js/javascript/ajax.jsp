            ...
            window.addEventListener("load", function(e) {
              ...
              /*  window.addEventListener("load", function(e) {
            	   var regButton =document.querySelector("#reg-button");
                    ...
                    moreBtn/removeEventListener("clikc",a);

                    
                    regButton.onclick=function(){
                    	var request = new window.XMLHttpRequest();
                        request.open("GET", "notice-reg-patial.jsp", true);
                     request.onload = function() {
                         ...
                         formscreen.style.width="100%";
                         formscreen.style.height="100%";
                         formscreen.style.position="absolute";
                         formscreen.style.left="0px";
                         formscreen.style.top="0px";
                         formscreen.style.background="#000";
                     ...
                     //   var data=eval('[{code:"1", title:"오오오"},{code:"2", title:"요요요"},   {code:"3", title:"유유윱"}]');
                     /*                var data=JSON.parse('[{"code":"1", "title":"오오오"},{"code":"2", "title":"요요요"},   {"code":"3", "title":"유유윱"}]');
                                    alert(data[1].title); */
            
                     //var request=new ActiveObjext("MIscrosoft.XMLHTTP");
                     var request = new window.XMLHttpRequest();
